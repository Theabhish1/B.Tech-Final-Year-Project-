...
class Attendence:
    def __init__(self,root):
     ...
     #"""""""""""""""""""""""""""""""""""""""Search System"""""""""""""""""""""""""""""""""
        ...
        back_button = Button(self.root, text="Back", font=("times new roman", 10, "bold"),width=18, bg="orange", command=self.go_back,activebackground="orange")
        back_button.place(x=1130, y=20)  # Adjust x and y coordinates as needed
