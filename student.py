...
class Student:
    def __init__(self,root):
        ...
        #"""""""""""""""""""""""""""""""""""""""""""""""""""left label frame"""""""""""""
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",fg='green',font=("times new roman",12,"bold"))
        ...
        self.studentid_entry.grid(row=0, column=1, padx=0, pady=10)  # Adjusting sticky parameter to "W" for left alignment
                ...
                # Assuming self.student_id_entry is the Entry widget for the student ID
        self.studentid_entry.config(validate="key")
        self.studentid_entry.config(validatecommand=(self.root.register(self.validate_roll), "%S"))
        ...
        take_photo_btn=Button(button_frame,command=self.generate_dataset,text="Take a Photo Sample",width=90,font=("times new roman",10,"bold"),bg="sky blue",fg="black")
        take_photo_btn.grid(row=6,column=4,padx=0,pady=0)
        
        back_button = Button(self.root, text="Back", cursor="hand2",font=("times new roman", 10, "bold"),width=14, bg="orange", command=self.go_back,activebackground="orange")
        back_button.place(x=1160, y=155)  # Adjust x and y coordinates as needed
      
        #"""""""""""""""""""""""""""""""""""right label frame"""""""""""""""""""""""""""""""""
        right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",fg='green',font=("times new roman",12,"bold"))
    ...
    def add_data(self):
        ...
        elif not self.var_mail.get().endswith('@gmail.com'):
            messagebox.showwarning("Error", "Email must end with '@gmail.com'", parent=self.root)
...
#"""""""fetch data"""""""""""""""""""""""""""""""""""""""""""
    # Modify the fetch_data method to include the fetch_data_on_click logic
...
#""""""""""""""Generate dataset or Take Photo Sample""""""""""""""""""'
    ...
    def validate_id(self, input_char):
        return input_char.isdigit() # Returns True if input is a digit, False otherwise
